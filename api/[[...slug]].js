...
var listEventsQuerySchema = import_zod3.z.object({
  ...
  limit: import_zod3.z.coerce.number().int().min(1).max(500).default(50),
...
// src/modules/portfolio/portfolio-case-studies.seed.ts
var TECH_ROWS = [
...
var AI_ATTENDANCE = {
  ...
  intro: "An AI-powered attendance management system transforming workforce management at Vadodara Municipal Corporation (VMC). 8,000+ employees mark attendance daily through the mobile app \u2014 verified by AI, validated by geo-fencing, and monitored in real time.",
  heroMeta: [
  ...
  problem: "Manual registers and legacy biometric machines couldn't keep up with a workforce spread across hundreds of municipal locations. Proxy entries, delayed reporting, and zero real-time visibility made accurate workforce management nearly impossible.",
  solution: "We combined AI face verification with geo-fencing based validation so every punch is both genuinely the employee and genuinely on site. Group attendance capture handles field teams, while real-time monitoring and a centralized dashboard give VMC live visibility across every location.",
  features: [
    {
      title: "AI-Verified Attendance",
      description: "Face verification on every punch ensures the right person marks attendance \u2014 no proxies.",
      icon: "ScanFace",
      accent: "blue"
    },
    {
      title: "Geo-Fencing Validation",
      description: "Attendance is accepted only within assigned geo-fenced work zones across the city.",
      icon: "MapPin",
      accent: "neutral"
    },
    {
      title: "Group Attendance Capture",
      description: "Supervisors capture entire field teams in one shot \u2014 ideal for on-site municipal crews.",
      icon: "Users",
      accent: "purple"
    },
    {
      title: "Real-Time Monitoring",
      description: "Live attendance status streams to administrators the moment employees check in.",
      icon: "Activity",
      accent: "amber"
    },
    {
      title: "Central Dashboard & Analytics",
      description: "Centralized reporting, trends, and analytics across all departments and locations.",
      icon: "LayoutDashboard",
      accent: "rose"
    },
    {
      title: "Built for Mobile",
      description: "A fast, reliable mobile app that thousands of employees use every single day.",
      icon: "Smartphone",
      accent: "indigo"
    }
  ],
  ...
  roiSectionDescription: "One of the largest attendance deployments in the municipal sector \u2014 accurate, proxy-free, and visible in real time across the entire city.",
  screens: [
    {
  ...
  workflowSteps: [
    {
      ...
      description: "On-device face verification models validate identity instantly, even in low-connectivity field conditions."
    },
    {
      step: "02",
      title: "Geo-Fencing Engine",
      description: "Location services validate every punch against assigned geo-fenced zones \u2014 wards, offices, and field sites."
    },
    {
      step: "03",
      title: "Real-Time Backbone",
      description: "Node.js microservices with Redis and Socket.IO stream attendance events live to the centralized dashboard."
    }
  ],
  stackSectionDescription: "AI verification and geo-fencing on the edge, backed by a real-time cloud pipeline that serves thousands of users every day without breaking a sweat.",
  architecture: "",
  order: 2
};
var AI_CALL_BOT = {
  ...
  heroMeta: [
    ...
    { label: "Timeframe", value: "12 weeks \xB7 2025" },
  ...
  problem: "Hospital front desks field hundreds of appointment calls daily. Hold times stretch past 20 minutes, staff burn out on repetitive booking tasks, and after-hours callers hit voicemail with no way to schedule until morning.",
  solution: "We built an AI call agent that answers every line instantly, looks up patient records in real time, checks doctor availability across departments, and books appointments \u2014 all through natural conversation with sub-150ms response times.",
  features: [
    {
      title: "Patient DB Lookup",
      description: "Real-time access to patient history, allergies, and prior visits during every call.",
      icon: "Database",
      accent: "blue"
    },
    {
      title: "Smart Scheduling",
      description: "Cross-department availability checks with insurance validation and conflict detection.",
      icon: "Calendar",
      accent: "emerald"
    },
    {
      title: "Ultra-low Latency",
      description: "Sub-150ms voice round-trip via streaming STT, cached context, and edge inference.",
      icon: "Zap",
      accent: "amber"
    },
    {
      title: "HIPAA Compliant",
      description: "End-to-end encryption, audit logging, and PHI handling aligned with healthcare standards.",
      icon: "Shield",
      accent: "rose"
    },
    {
      title: "Sentiment Detection",
      description: "Detects patient distress or urgency and escalates to a live nurse or doctor instantly.",
      icon: "HeartPulse",
      accent: "purple"
    },
    {
      title: "Multi-language",
      description: "Supports 20+ languages for diverse patient populations with accent-adaptive STT.",
      icon: "Users",
      accent: "indigo"
    }
  ],
  ...
  roi: [
    {
      ...
      description: "Ultra-low latency voice pipeline keeps conversations natural \u2014 patients never wait for the AI to think.",
      icon: "Zap"
    },
    {
      value: "85%",
      label: "Calls self-resolved",
      description: "Most appointment bookings, reschedules, and reminders handled end-to-end without human transfer.",
      icon: "TrendingUp"
    },
    {
      value: "24/7",
      label: "Always available",
      description: "Round-the-clock scheduling coverage eliminates missed calls and after-hours voicemail backlogs.",
      icon: "Clock"
    },
    {
      value: "12+",
      label: "Departments integrated",
      description: "Cardiology, orthopedics, pediatrics, and more \u2014 unified scheduling across the hospital network.",
      icon: "Building2"
    }
  ],
  roiSectionDescription: "The hospital network reduced front-desk call volume, eliminated scheduling backlogs, and improved patient satisfaction \u2014 all while maintaining HIPAA compliance.",
  screens: [
    {
      label: "Inbound Intake",
      caption: "Natural voice greeting and triage",
      description: "Patients call the hospital line and speak naturally. The AI agent identifies intent, verifies identity, and routes to the right department \u2014 no IVR maze.",
      image: "/projects/ai-call-bot-hospital/inbound.jpg"
    },
    {
      label: "Live Scheduling",
      caption: "Real-time appointment booking",
      description: "The agent queries live doctor availability, suggests optimal slots, confirms insurance, and books directly into the hospital scheduling system.",
      image: "/projects/ai-call-bot-hospital/scheduling.jpg"
    },
    {
      label: "Patient Records",
      caption: "Secure EHR database integration",
      description: "HIPAA-compliant lookup of patient history, prior visits, prescriptions, and allergies \u2014 surfaced contextually during the call for personalized care.",
  ...
  workflowSteps: [
    {
      step: "01",
      title: "Voice Ingress",
      description: "GoTo and RingCentral SIP trunks stream audio through LiveKit for real-time transcription with speaker diarization and noise cancellation."
    },
    {
      step: "02",
      title: "AI Orchestration",
      description: "Node.js agents query US EHR APIs and MongoDB patient records, check scheduling systems, and generate natural responses via Gemini."
    },
    {
      step: "03",
      title: "Deploy & Scale",
      description: "RingCentral-integrated voice services on AWS with auto-scaling, HIPAA-compliant logging, and failover routing for 99.9% uptime."
    }
  ],
  stackSectionDescription: "A real-time voice pipeline connecting GoTo and RingCentral telephony, LiveKit streams, Gemini reasoning, and US EHR APIs \u2014 engineered for sub-150ms round-trip latency.",
  architecture: "",
  order: 1
};
var BUSINESS_MEET = {
  ...
  timeframe: "14 weeks \xB7 2025",
  role: "Full-stack & AI Engineering",
  intro: "An AI-powered networking and travel platform connecting professionals, travelers, and local communities through intelligent matching and real-time engagement \u2014 with AI-based recommendations for profiles, connections, meetings, and minutes of meeting.",
  heroMeta: [
    { label: "Client", value: "Business Meet (Internal)" },
    { label: "Timeframe", value: "14 weeks \xB7 2025" },
    { label: "Role", value: "Full-stack & AI Engineering" },
  ...
  problem: "Professionals traveling to new cities and events waste hours on cold outreach and irrelevant introductions. Discovering the right people \u2014 by field, interest, destination, and timing \u2014 is left entirely to chance, and meeting outcomes evaporate without structured follow-up.",
  solution: "We built an AI traveler-matching engine using GPT-4o-mini and vector search that connects users on destination, interests, and travel dates. Field-aware recommendations surface profiles, connections, and meetings, while AI-generated minutes of meeting and microservice-based email and WhatsApp notifications keep every conversation moving.",
  features: [
    {
      title: "Profile Recommendations",
      description: "Field-aware AI suggests the most relevant professionals to your goals and industry.",
      icon: "Users",
      accent: "blue"
    },
    {
      title: "Smart Connections",
      description: "Vector search matches on destination, interests, and travel dates for high-signal intros.",
      icon: "Sparkles",
      accent: "neutral"
    },
    {
      title: "Meeting Suggestions",
      description: "AI proposes when, where, and with whom to meet based on shared context and availability.",
      icon: "Calendar",
      accent: "purple"
    },
    {
    ...
    },
    {
      ...
      description: "Interactive maps and real-time dashboard synchronization keep engagement live.",
      icon: "MapPin",
      accent: "rose"
    },
    {
      title: "Multi-channel Alerts",
      description: "Scalable microservices push email and WhatsApp notifications the moment things change.",
      icon: "MessageSquare",
      accent: "indigo"
    }
  ],
  ...
  roiSectionDescription: "From first recommendation to signed-off minutes, Business Meet compresses the entire networking lifecycle into one intelligent flow.",
  screens: [
    {
  ...
  workflowSteps: [
    {
      ...
      description: "GPT-4o-mini enriches profiles into embeddings; vector search ranks candidates by destination, interests, and travel dates."
    },
    {
      step: "02",
      title: "Responsive Frontend",
      description: "Modern component architecture with optimistic updates and streaming data delivers near-instant page loads and smooth interactions."
    },
    {
      step: "03",
      title: "Real-time Microservices",
      description: "Event-driven notification services for email and WhatsApp, with Socket.IO powering live maps and dashboard synchronization."
    }
  ],
  stackSectionDescription: "An AI-driven matching engine on top of a scalable microservice backbone, delivering real-time updates, interactive maps, and live dashboard synchronization.",
  architecture: "",
  order: 3
};
var CASE_STUDIES = [AI_CALL_BOT, AI_ATTENDANCE, BUSINESS_MEET];
async function ensureTechStackRows() {
  const existing = await TechStackModel.find({
    name: { $in: TECH_ROWS.map((t) => t.name) }
  }).select("name icon color description").lean().exec();
