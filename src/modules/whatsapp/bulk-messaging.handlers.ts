...
export const getCampaignAnalytics = async (
  ...
  try {
    ...
    if (params.campaignId) {
      // Fix #5: Add ObjectId validation before creating ObjectId
      ensureValidObjectId(params.campaignId);
